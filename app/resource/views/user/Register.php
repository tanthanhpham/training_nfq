        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <?php } ?>
                    <form method="POST" action="HandleLogin.php" class="register-form" id="register-form">
                        <div class="form-group">
                            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="text" name="name" id="name" placeholder="Your Name" required value="<?php if(isset($_SESSION["oldData"]["name"])) echo $_SESSION["oldData"]["name"]; ?>"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" placeholder="Your Email" required value="<?php if(isset($_SESSION["oldData"]["email"])) echo $_SESSION["oldData"]["email"]; ?>"/>
                        </div>
                        <div class="form-group">
